...
package oishik.keyboard.latin.inputlogic;
...
import oishik.keyboard.latin.Dictionary;
import oishik.keyboard.latin.DictionaryFacilitator;
import oishik.keyboard.latin.LastComposedWord;
import oishik.keyboard.latin.LatinIME;
import oishik.keyboard.latin.NgramContext;
import oishik.keyboard.latin.RichInputConnection;
import oishik.keyboard.latin.Suggest;
...
import oishik.keyboard.latin.WordComposer;
import oishik.keyboard.latin.common.Constants;
import oishik.keyboard.latin.common.InputPointers;
import oishik.keyboard.latin.common.StringUtils;
import oishik.keyboard.latin.common.StringUtilsKt;
import oishik.keyboard.latin.common.SuggestionSpanUtilsKt;
import oishik.keyboard.latin.define.DebugFlags;
import oishik.keyboard.latin.settings.SettingsValues;
import oishik.keyboard.latin.settings.SpacingAndPunctuations;
import oishik.keyboard.latin.suggestions.SuggestionStripViewAccessor;
import oishik.keyboard.latin.utils.AsyncResultHolder;
import oishik.keyboard.latin.utils.InputTypeUtils;
import oishik.keyboard.latin.utils.Log;
import oishik.keyboard.latin.utils.RecapitalizeStatus;
import oishik.keyboard.latin.utils.ScriptUtils;
import oishik.keyboard.latin.utils.StatsUtils;
import oishik.keyboard.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link oishik.keyboard.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link oishik.keyboard.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link oishik.keyboard.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, oishik.keyboard.latin.SuggestedWords)}.
