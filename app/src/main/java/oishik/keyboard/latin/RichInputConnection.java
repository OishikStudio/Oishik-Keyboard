...
import oishik.keyboard.latin.common.UnicodeSurrogate;
...
import oishik.keyboard.latin.utils.DebugLogUtils;
import oishik.keyboard.latin.utils.NgramContextUtils;
import oishik.keyboard.latin.utils.ScriptUtils;
import oishik.keyboard.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See oishik.keyboard.latin.common.Constants.UnicodeSurrogate
